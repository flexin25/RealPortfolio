  ...
  return (
    <div className={cn("grid gap-4", compact ? "md:grid-cols-2" : "md:grid-cols-2 lg:grid-cols-4")}>
      {groups.map((g, gi) => (
        ...
        >
          <h3 className="mb-3 text-sm font-medium text-zinc-300">{g.label}</h3>
            ...
            {tech
              ...
              .map((t, idx) => (
                <motion.div
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-lg border border-white/10 bg-black px-3 py-2 text-center text-sm text-zinc-200 transition-transform hover:-translate-y-0.5"
                >
